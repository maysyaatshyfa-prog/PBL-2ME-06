...
Route::get('/rooms/type/{type}', [RoomVariantController::class, 'type'])
    ->name('rooms.type');
...
/* BOOKING */
 Route::get('/booking/{id}', [BookingController::class, 'create'])
    ...
    Route::post('/booking/confirm', [BookingController::class, 'confirm'])
        ...
        Route::post('/booking/{id}/upload-ktp', [BookingController::class, 'uploadKtp'])
    ->name('booking.uploadKtp');
...
/* 🔥 MIDTRANS NOTIFICATION (WAJIB ADA) */
...
Route::prefix('admin')->middleware('auth')->group(function () {
    ...
    Route::post('/kamar/tambah', [AdminController::class, 'tambahKamar'])
        ->name('admin.kamar.tambah');

    Route::get('/reservasi', [AdminController::class, 'reservasiIndex'])
        ->name('admin.reservasi.index');

        Route::post('/reservasi/status/{id}', [AdminController::class, 'updateStatus'])
    ...
    Route::post('/pembatalan/acc/{id}', [AdminController::class, 'accPembatalan'])
        ->name('admin.pembatalan.acc');

    Route::post('/pembatalan/tolak/{id}', [AdminController::class, 'tolakPembatalan'])
